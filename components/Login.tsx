...
const Login = () => {
    ...
    return (
        ...
        >
            ...
            <button className="text-white flex gap-4 items-center justify-center px-4 py-2 bg-google border border-2 rounded border-google-hover hover:bg-google-hover" onClick={() => google()}>
